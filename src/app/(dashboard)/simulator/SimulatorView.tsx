...
import { AlertTriangle, Flag, Minus, Plus, RotateCcw, ShieldCheck, Thermometer } from 'lucide-react'
        ...
        <div className="p-[23px] border border-surface-line bg-surface-panel rounded-lg overflow-hidden">
          ...
          {FIELDS.map(({ key, label, unit, min, max }) => (
            <label className="block my-[28px]" key={key}>
              ...
              />
              <small className="flex justify-between text-content-muted text-[10px] mt-[2px]">
                {min} {unit}
