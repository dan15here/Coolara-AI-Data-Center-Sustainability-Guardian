...
export default function LandingScrollTabs() {
  ...
  const pendingTargetRef = useRef<(typeof tabs)[number]['id'] | null>(null)
  ...
  useEffect(() => {
    ...
    const updateActiveTab = () => {
      ...
      if (pendingTargetRef.current) {
        if (pendingTargetRef.current !== nextId) return
  ...
  const handleTabClick = (event: React.MouseEvent<HTMLAnchorElement>, targetId: (typeof tabs)[number]['id']) => {
